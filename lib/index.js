...
var SmartyStreetsError = require('./error')('SmartyStreetsError');
...
SmartyStreets.suggest = function suggest(data, fn) {
  ...
  if (!data || !data.prefix) return fn(new SmartyStreetsError('Prefix is required.'));
